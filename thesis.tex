...
To achieve these speeds, our implementation outputted LZ factorizations that were on average only 0.01 percent greater than what could be computed sequentially.
