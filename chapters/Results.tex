...
Our GPU implementation did not see the speedup of 35x that theirs did, but we still found around a 4-5x speedup for most files.
...
The first and most important metric to look at is how the BLZ chunk size affects the final LZ factorization size.
...
To pick the different chunk sizes, I decided to use number of divisions as the parameter, although I could have used the actual block size as mentioned before.
